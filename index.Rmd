...
cmptab2 <- reactive({
  ...
  out <- cmprctfun2(datin, fluccs, yrsel2[1], '2020', subt = T)
...
column(12,
  column(6,
    download_this(
      acresdl,
      output_name = "supra_inter_acres",
      output_extension = ".csv",
      button_label = "Download supratidal/intertidal annual estimates",
      button_type = "warning",
      has_icon = TRUE,
      icon = "fa fa-save"
      )
  ...
  column(6,
    download_this(
      subtacresdl,
      output_name = "sub_acres",
      output_extension = ".csv",
      button_label = "Download subtidal annual estimates",
      button_type = "warning",
      has_icon = TRUE,
      icon = "fa fa-save"
      )
